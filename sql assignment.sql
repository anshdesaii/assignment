...
-- 21select department_id , avg(salary) from employees
-- group by department_id 

-- 22 select department_id ,max(salary) from employees
 -- group by department_id

/*SET  SQL_SAFE_UPDATES = 0;
 23select salary from employees
 where commission_pct is not null;
update employees
 set salary = salary + (salary*10/100);*/
 
-- 24 select first_name,last_name  from employees
 -- order by salary desc
 -- limit 1
 
-- 25select first_name,last_name  from employees
-- order by salary 


-- 26select last_name ,department_name from employees
-- join  departments
-- on employees.department_id=departments.department_id
 
/* 27 select employees.last_name ,departments.department_name, locations.location_id,locations.city from employees
join departments
on employees.department_id=departments.department_id 
join locations
on departments.location_id=locations.location_id*/

/* 28select last_name ,department_name from employees
join  departments
on employees.department_id=departments.department_id
